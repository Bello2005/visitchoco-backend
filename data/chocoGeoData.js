...
exports.chocoGeoData = void 0;
exports.chocoGeoData = {
    ...
    features: [
        {
            ...
            properties: {
                name: "Quibdó",
                description: "Capital del departamento del Chocó y centro cultural y económico de la región.",
        ...
        },
        {
            ...
            properties: {
                name: "Nuquí",
                description: "Paraíso costero conocido por el avistamiento de ballenas jorobadas y sus playas vírgenes.",
        ...
        },
        {
            ...
            properties: {
                name: "Bahía Solano",
                description: "Importante destino turístico conocido por sus playas y actividades acuáticas.",
